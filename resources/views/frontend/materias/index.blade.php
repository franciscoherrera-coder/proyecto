            ...
            @foreach ($novedades as $novedad)
                ...
                <div class="card col-lg-4 col-md-10 sm-12 row-hijos">
                    ...
                    <div class="card-body">
                        ...
                        @if ($novedad->archivo1)
                            <a href="{{ asset('./storage/' . $novedad->archivo1) }}"
                                target="_blank">{{ basename($novedad->archivo1) }}</a>
                        @endif
                        @if ($novedad->archivo2)
                            <a href="{{ asset('./storage/' . $novedad->archivo2) }}"
                                target="_blank">{{ basename($novedad->archivo2) }}</a>
                        @endif
                        @if ($novedad->archivo3)
                            <a href="{{ asset('./storage/' . $novedad->archivo3) }}"
                                target="_blank">{{ basename($novedad->archivo3) }}</a>
                        @endif
                    </div>
                </div>
                @if ($twice == 2)
