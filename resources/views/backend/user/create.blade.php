...
<div class="col-lg-8 col-md-10 mx-auto border rounded p-3 shadow-sm">
    ...
    <div class="mb-3">
        {{ Form::label("telefono", 'Teléfono', ['class' => 'form-label fw-bold']) }}
    ...
    <div class="mb-3">
        {{ Form::label("rol", 'Rol', ['class' => 'form-label fw-bold']) }}
    ...
    <div class="mb-3">
        {{ Form::label("password-confirm", 'Confirm Password', ['class' => 'form-label fw-bold']) }}
    ...
    <div class="mb-0">
        {{ Form::checkbox('is_admin', null, null, ['class' => 'form-check-input']) }}
        {{ Form::label("is_admin", 'Admin?', ['class' => 'form-label-check']) }}
        @error('is_admin')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
    </div>
