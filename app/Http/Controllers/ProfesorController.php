...
class ProfesorController extends Controller
{
    ...
    $profesores = $query->orderBy('apellido')->paginate(25)->withQueryString();
    ...
    public function update(Request $request, $id)
    {
        ...
        // 🔹 Recupero la página actual (si no existe, vuelvo a la 1)
        $page = $request->input('page', 1);

        return redirect()->route('profesor.index', ['page' => $page]);
    }
