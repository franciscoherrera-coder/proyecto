...
Route::group(['middleware' => ['preceptor']], function () {
...
Route::get('/horarios/resoluciones/{carrera}', [App\Http\Controllers\HorarioController::class, 'getResolucionesByCarrera']);
